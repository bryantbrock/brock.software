    ...
    <main>
      ...
      <section className="center grid mt-40">
        <div className="bg-gradient-to-br from-gray-500 to-black inline-block text-transparent bg-clip-text">
          <h1 className="text-[66px] text-center font-bold max-w-[710px] mx-auto leading-tight">
            Build custom web apps at the speed of light.
          </h1>
        </div>
        <h4 className="text-center mx-auto mt-4 max-w-[620px] text-2xl">
          We help businesses build custom software that increases efficiency,
                  ...
                  <div className="absolute inset-0 rounded-lg flex flex-col justify-end">
                    ...
                    <div className="bg-white p-6 flex flex-col gap-2">
                      ...
                      <h4 className="text-xl">
                        A mobile app marketplace for security guards and venues
                      </h4>
                    </div>
                  </div>
                </div>
      ...
      {/* Scores */}
      <div className="bg-gray-50 border-y my-28">
        <section className="center p-12 flex justify-between md:justify-around">
